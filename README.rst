...
This fork of DeepSpeech includes a script to transcribe a folder of .WAV files `process_folder.py <native_client/python/process_folder.py>`_ and export the results to a .CSV.
